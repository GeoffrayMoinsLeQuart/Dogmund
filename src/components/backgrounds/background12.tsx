...
import { CoinOneRightMobile, CoinThreeLeftMobile, CoinThreeRightMobile, CoinTwoLeftMobile, CoinTwoRightMobile } from './coins';
...
const Background12: React.FC<BackgroundProps> = ({ comingFrom }) => {
	...
	return (
		<div className='absolute w-full h-full -z-[1]'>
			...
			<CoinTwoRightMobile classname={`${visible} top-[72%] -left-[10%]`} />
			<CoinThreeLeftMobile classname={`${visible} top-[140%] left-[5%]`} />
			<CoinOneRightMobile classname={`${visible} top-[5%] right-[5%]`} />
			<CoinTwoLeftMobile classname={`${visible} top-[72%] -right-[10%]`} />
